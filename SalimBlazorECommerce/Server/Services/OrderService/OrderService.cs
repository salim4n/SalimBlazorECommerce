...
namespace SalimBlazorECommerce.Server.Services.OrderService
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<ServiceResponse<OrdersDetailsResponse>> GetOrdersDetails(int orderId)
        {
            var response = new ServiceResponse<OrdersDetailsResponse>();
            ...
            var orderDetailsResponse = new OrdersDetailsResponse
            {
                OrderDate = order.OrderDate,
                TotalPrice = order.TotalPrice,
                Products = new List<OrderDetailsProductsResponse>()
        };
            order.OrderItems.ForEach(item => orderDetailsResponse.Products.Add(new OrderDetailsProductsResponse
            {
